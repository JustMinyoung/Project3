...
<form action="${home }board/hiProc" method="post">
	<div class="board_box">
		<div>
			<div class="bvb_title">
				<input type="text" name="title" id="title" class="text_title" value="${highlight.title }"/>
			</div>
		...
		<div class="bvb_contents_write">
			<div>
				<textarea name="contents" id="summernote">${highlight.contents }</textarea>
			</div>
			<script>
